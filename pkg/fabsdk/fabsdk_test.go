...
import (
	...
	context2 "github.com/vtbaas/vbaas-go-sdk/pkg/context"
	...
	mockapisdk "github.com/vtbaas/vbaas-go-sdk/pkg/fabsdk/test/mocksdkapi"
...
func TestErrorHandler(t *testing.T) {
	...
	errHandler := func(ctxt fab.ClientContext, channelID string, err error) {
		...
		//https://github.com/vtbaas/vbaas-go-sdk/pull/62#issuecomment-605343770
